...
import {
  ...
  createFlowmapSelectionHighlightLayers,
  defaultFeatureValues,
  extendBoundsWithGeoBounds,
  findFlowmapSelectionHighlight,
  getSourceSignature,
  isBooleanColumnType,
  isEditableFeatureColumn,
  isGeoJsonMapLayer,
  isGeoJsonPolygonGeometry,
  isGeoJsonTableSource,
  isPolygonGeometryType,
  isVectorTileRequestError,
